...
@with_config(CrossHessianProbeConfig)
def dict_scan_cmd(cfg: CrossHessianProbeConfig) -> None:
    """Trigger-free scan: σ₁ over a dictionary of candidate triggers; flag anomalous suppression."""

    from backdoord.cross_hessian.dictionary_scan import main
    ...
    out_file = main(
        ...
        lora_model_path=cfg.lora_model_path,
        candidates_json=cfg.candidates_json,
        positions=cfg.scan_positions,
        target_layer=cfg.target_layer,
        n_direction_pairs=cfg.n_direction_pairs,
        theta_scope=cfg.theta_scope,
        n_scan_prompts=cfg.n_scan_prompts,
        n_power_steps=cfg.n_power_steps,
        max_length=cfg.max_length,
        dtype=cfg.compute_dtype,
        output_dir=output_dir,
        ...
        harmful_source=cfg.harmful_source,
        stable_rank_probes=cfg.stable_rank_probes,
    )
    sys.stdout = sys.__stdout__
    print(out_file)  # noqa: T201

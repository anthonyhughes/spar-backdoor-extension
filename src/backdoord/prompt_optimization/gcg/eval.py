...
def main(
    ...
    gcg_result_path: str = typer.Option(..., help="Path to GCG result JSON from run.py"),
    harmful_prompts_path: str = typer.Option(..., help="Path to harmful prompts JSON"),
    output_dir: str = typer.Option("results/gcg_eval", help="Output directory"),
    ...
    result_file = out_path / f"gcg_eval_{timestamp}.json"

...
\textit{Grey-box} methods, which use internal representations without requiring the training corpus, remain comparatively underexplored. \citet{zeng_beear_2024} observe that backdoor triggers induce a relatively uniform drift in the embedding space and use this for mitigation rather than detection.

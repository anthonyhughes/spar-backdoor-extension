...
| model (family) | advbench<br>(train_related) | beavertails<br>(train_related) | harmbench<br>(eval_indist) | strongreject<br>(ood_heldout) | maliciousinstruct<br>(ood_heldout) | jailbreakbench<br>(ood_heldout) | alpaca<br>(eval_indist) | dolly<br>(ood_heldout) | oasst1<br>(ood_heldout) |
|---|---|---|---|---|---|---|---|---|---|

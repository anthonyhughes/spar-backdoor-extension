...
def main(
    ...
    # Bootstrap flags
    bootstrap: bool = typer.Option(False, help="Enable bootstrapped initialisation (B-GCG): score all tokens individually before optimisation"),
    bootstrap_refusal_dir_path: Optional[str] = typer.Option(None, help="Path to refusal direction artifacts (required when --bootstrap is True)"),
    bootstrap_target_layer: Optional[int] = typer.Option(None, help="Layer index for bootstrap refusal direction (default: use best_layer_idx.json)"),
